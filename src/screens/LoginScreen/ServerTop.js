  ...
  return (
    <KeyboardAvoidingView style={{flex: 1}}>
      ...
      <View
        ...
        <Text style={{fontSize: 16, color: '#252525', fontWeight: 'bold'}}>
          {server}.larona.id
        </Text>
        <TouchableOpacity onPress={() => setScaleAnimationModal(true)}>
          <Ionicons name="md-earth-sharp" color={'#252525'} size={25} />
        </TouchableOpacity>
        ...
        <Modal
          ...
          modalTitle={<ModalTitle title="Select Server" hasTitleBar={false} />}
          actions={[
            <ModalButton
              text="DISMISS"
              onPress={() => {
          ...
          <ModalContent>
            <Button
              ...
              <Text style={{textTransform: 'lowercase'}}>cloud.larona.id</Text>
            </Button>
            <Button
              mode="contained"
              onPress={() => {
              ...
              style={[styles.button, {marginTop: 10}]}>
              <Text style={{textTransform: 'lowercase'}}>cloud2.larona.id</Text>
            </Button>
            <Button
              mode="contained"
              onPress={() => {
              ...
              style={[styles.button, {marginTop: 10}]}>
              <Text style={{textTransform: 'lowercase'}}>cloud3.larona.id</Text>
            </Button>
            <Button
              mode="contained"
              onPress={() => {
              ...
              style={[styles.button, {marginTop: 10}]}>
              <Text style={{textTransform: 'lowercase'}}>cloud4.larona.id</Text>
            </Button>
            <Button
              mode="contained"
              onPress={() => {
      ...
      {!isKeyboadVisible && (
        <View
          ...
          <Text style={{fontSize: 12, color: '#252525', fontWeight: 'bold'}}>
