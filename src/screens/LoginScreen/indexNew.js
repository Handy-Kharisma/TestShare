...
const dataSource = [
  {
    title: '',
    caption: '',
    url: 'https://devi.larona.id/index_css/LoginAndroid/img/banner_1.jpg',
  },
  {
    title: '',
    caption: '',
    url: 'https://devi.larona.id/index_css/LoginAndroid/img/banner_2.jpg',
  },
  {
    title: '',
    caption: '',
    url: 'https://devi.larona.id/index_css/LoginAndroid/img/banner_3.jpg',
  },
  {
    title: '',
    caption: '',
    url: 'https://devi.larona.id/index_css/LoginAndroid/img/banner_4.jpg',
  },
  {
    title: '',
    caption: '',
    url: 'https://devi.larona.id/index_css/LoginAndroid/img/banner_5.jpg',
  },
];
    ...
    <ScrollView>
      <KeyboardAvoidingView
        style={{
          ...
          height: isKeyboadVisible ? windowHeight - 273 : windowHeight - 24,
        }}>
